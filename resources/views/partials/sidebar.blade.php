                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a
                            ...
                            @click="selected = (selected === 'Mahasiswa' ? '':'Mahasiswa')"
                            class="menu-item group"
                            :class=" (selected === 'Mahasiswa') || (page === 'mahasiswa') ? 'menu-item-active' : 'menu-item-inactive'"
                        >
                            <svg
                                :class="(selected === 'Mahasiswa') || (page === 'mahasiswa') ?  'menu-item-icon-active'  :'menu-item-icon-inactive'"
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                fill="none"
